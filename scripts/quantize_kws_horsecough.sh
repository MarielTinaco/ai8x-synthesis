...
# python quantize.py trained/qat_human_others_12_best.pth.tar trained/qat_human_others_12_best-q.pth.tar --device MAX78000 -v
python quantize.py trained/qat_equine_1_best.pth.tar trained/qat_equine_1_best-q.pth.tar --device MAX78000 -v